...
4. To begin active development, run `npm start` or `yarn start`. This does several things for you:
 ...
 - Serves sandbox.html @ http://localhost:8080/ (browser-sync ui:  http://localhost:8080:8081/)
