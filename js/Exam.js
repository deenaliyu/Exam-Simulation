...
async function getExamId() {
  ...
  for (let i = 0; i < questionsId.length; i++) {
    ...
    asideoCount.innerHTML += `
            ...
            <label class="text-center" style="margin-left: 30%; font-size: 14px">Q${i+1}</label>
...
submitBtn.addEventListener("click", (e) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      window.location.href = "https://docs.google.com/forms/d/17hjsOkH9lmHlLEUjqMBohE2Ds-t4yvSoldhhN7-DBX4/edit"
      window.location.href = "https://docs.google.com/forms/d/17hjsOkH9lmHlLEUjqMBohE2Ds-t4yvSoldhhN7-DBX4/edit"
    }
  })
